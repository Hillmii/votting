<footer class="bg-primary-2 text-white py-8 w-auto">
    <div class="flex flex-wrap">
        <div class="w-1/2 lg:w-1/4 ml-10 mb-6 lg:mb-0">
            <h2 class="text-2xl font-semibold mb-4">Page</h2>
            <ul>
                <li><a href="{{ route('home') }}" class="text-gray-400 hover:text-white">Home</a></li>
                <li><a href="{{ route('poll') }}" class="text-gray-400 hover:text-white">Vote Settings</a></li>
                <li><a href="{{ route('login') }}" class="text-gray-400 hover:text-white">Login</a></li>
                <li><a href="{{ route('registrasi') }}" class="text-gray-400 hover:text-white">Registrasi</a></li>
                <li><a href="{{ route('about') }}" class="text-gray-400 hover:text-white">About</a></li>
            </ul>
        </div>
        <div class="w-1/2 lg:w-1/4 mb-6 lg:mb-0 ml-10">
            <h2 class="text-2xl font-semibold mb-4">Social Media</h2>
            <ul>
                <li><a href="https://www.facebook.com/" target="blank" class="text-gray-400 hover:text-white flex">
                    <?xml version="1.0" ?><!DOCTYPE svg  PUBLIC '-//W3C//DTD SVG 1.1//EN'  'http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd'>
                    <svg class="w-6 h-6 mr-3" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;" version="1.1" viewBox="0 0 512 512" width="100%" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:serif="http://www.serif.com/" xmlns:xlink="http://www.w3.org/1999/xlink"><g><path d="M512,256c0,-141.385 -114.615,-256 -256,-256c-141.385,0 -256,114.615 -256,256c0,127.777 93.616,233.685 216,252.89l0,-178.89l-65,0l0,-74l65,0l0,-56.4c0,-64.16 38.219,-99.6 96.695,-99.6c28.009,0 57.305,5 57.305,5l0,63l-32.281,0c-31.801,0 -41.719,19.733 -41.719,39.978l0,48.022l71,0l-11.35,74l-59.65,0l0,178.89c122.385,-19.205 216,-125.113 216,-252.89Z" style="fill:#1877f2;fill-rule:nonzero;"/><path d="M355.65,330l11.35,-74l-71,0l0,-48.022c0,-20.245 9.917,-39.978 41.719,-39.978l32.281,0l0,-63c0,0 -29.297,-5 -57.305,-5c-58.476,0 -96.695,35.44 -96.695,99.6l0,56.4l-65,0l0,74l65,0l0,178.89c13.033,2.045 26.392,3.11 40,3.11c13.608,0 26.966,-1.065 40,-3.11l0,-178.89l59.65,0Z" style="fill:#fff;fill-rule:nonzero;"/></g></svg>
                        Facebook
                    </a>
                </li>
                <li><a href="https://twitter.com/?lang=id" target="blank" class="text-gray-400 hover:text-white flex my-3">
                    <?xml version="1.0" ?><svg class="w-6 h-6 mr-3" id="Layer_1" style="enable-background:new 0 0 1000 1000;" version="1.1" viewBox="0 0 1000 1000" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><style type="text/css">
                        .st0{fill:#1DA1F2;}
                        .st1{fill:#FFFFFF;}
                        .st2{fill:none;}
                ...
                <li><a href="https://www.instagram.com/" target="blank" class="text-gray-400 hover:text-white flex mb-3">
                    <?xml version="1.0" ?><svg class="w-6 h-6 mr-3" id="Layer_1" style="enable-background:new 0 0 1000 1000;" version="1.1" viewBox="0 0 1000 1000" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><style type="text/css">
                        ...
                        Instagram</a></li>
                <li><a href="https://www.youtube.com/" target="blank" class="text-gray-400 hover:text-white flex">
                    <?xml version="1.0" ?><svg class="w-6 h-6 mr-3" id="Layer_1" style="enable-background:new 0 0 1000 1000;" version="1.1" viewBox="0 0 1000 1000" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><style type="text/css">
                        .st0{fill:#FF0000;}
                        .st1{fill:#FFFFFF;}
    ...
    <div class="mt-8 text-center">
        <p>&copy; 2024 Vote me. All rights reserved.</p>
    </div>
</footer>